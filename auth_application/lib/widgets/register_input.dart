...
class RegisterIPWidget extends StatefulWidget {
  static const route = "/registerIP";
  const RegisterIPWidget({Key? key}) : super(key: key);

  @override
  State<RegisterIPWidget> createState() => _RegisterIPWidgetState();
}

class _RegisterIPWidgetState extends State<RegisterIPWidget>
